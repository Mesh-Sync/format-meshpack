...
| `meshsync_geometry` | MeshSync | contact@meshsync.net | Stable | `v1` | `https://meshsync.net/schemas/meshpack/2.0/extensions/meshsync_geometry.schema.json` | 3D geometry metadata |
| `meshsync_dependencies` | MeshSync | contact@meshsync.net | Stable | `v2` | `https://meshsync.net/schemas/meshpack/2.0/extensions/meshsync_dependencies.schema.json` | Material and texture references |
| `meshsync_printability` | MeshSync | contact@meshsync.net | Stable | `v1` | `https://meshsync.net/schemas/meshpack/2.0/extensions/meshsync_printability.schema.json` | 3D printing analysis results |
| `meshsync_content` | MeshSync | contact@meshsync.net | Stable | `v1` | `https://meshsync.net/schemas/meshpack/2.0/extensions/meshsync_content.schema.json` | Rich content metadata |
| `meshsync_thumbnails` | MeshSync | contact@meshsync.net | Stable | `v2` | `https://meshsync.net/schemas/meshpack/2.0/extensions/meshsync_thumbnails.schema.json` | Thumbnail and preview resource references |
...
Thumbnail and preview resource references generated by worker-thumbnail-generation (REQ-L3-050).
All fields are flat resource filenames pointing to entries in `resources/`.
...
**Field Descriptions (v2):**

| Field | Description |
|-------|-------------|
| `static` | Resource filename for a static thumbnail image (JPEG/PNG) |
| `animated_360` | Resource filename for an animated 360-degree preview (MP4/GIF) |
| `glb_preview` | Resource filename for a GLB 3D preview file |

> **Note**: All fields are optional. Values use the canonical MeshPack 2.0
> resource filename form: `{lowercase_hex_hash}.{extension}`. Algorithm prefixes,
> path separators, drive letters, UNC prefixes, and traversal segments are invalid.
